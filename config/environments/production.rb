Medical::Application.configure do
...
#  In production mode, Rails will not be responsible for serving static assets.
#  Therefore, you are getting this error. Thin won't do it either, since it's just a wrapper around Rails.
#
