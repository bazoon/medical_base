...
ActiveRecord::Schema.define(:version => 20130103135807) do
  ...
  create_table "inspections_neurologists", :force => true do |t|
    t.integer  "prof_inspection_id"
  ...
  create_table "ref_lab_test_groups", :force => true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "ref_lab_test_type_groups", :force => true do |t|
    t.integer  "lab_test_type_id"
